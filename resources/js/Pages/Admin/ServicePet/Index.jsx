...
export default function ServicePet({ servicePets, flash }) {
  ...
  const rows = servicePets.map((data, idx) => ({
    id: data.id,
    no: idx + 1,
  ...
  const columns = [
    ...
    { field: 'name_service', headerName: 'Nama Service', width: 200 },
    { field: 'price_service', headerName: 'Harga Service', width: 120 },
    { field: 'type_service', headerName: 'Type Service', width: 120 },
    { field: 'description_service', headerName: 'Deskripsi Service', width: 300 },
    {
      field: 'id',
      sortable: false,
      headerName: 'Action',
