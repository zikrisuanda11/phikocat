            ...
            <div className="flex gap-5 mx-56 justify-center  mt-10">
              <div className="border rounded-md shadow-md w-5/12">
                <div className="bg-grey_pink m-5 p-5 rounded-xl">
                  ...
                  <div className="my-3">
                    <div className="text-xs text-slate-500">Date Check-IN</div>
                    <p className="font-bold">{detailTransaction.date_checkin}</p>
                  </div>
                  <div className="my-3">
                    <div className="text-xs text-slate-500">Date Check-OUT</div>
                    <p className="font-bold">{detailTransaction.date_out}</p>
                  </div>
                  <div className="my-3">
